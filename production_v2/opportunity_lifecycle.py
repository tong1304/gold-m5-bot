...
def advance_opportunity(previous:dict[str,Any]|None,current:dict[str,Any])->dict[str,Any]:
    ...
    if p and pd in {"BUY","SELL"} and d in {"BUY","SELL"} and d!=pd:return {**c,"state":"REPLACED","continuity":"DIRECTION_CHANGED","previous_opportunity_id":pid,"opportunity_id":oid or pid,"direction":d,"setup":setup or previous_setup,"bars_waited":0,"origin_candle":p.get("origin_candle") or candle,"last_evaluated_candle":candle,"trade_authorized":False,"invalidation_reason":"DIRECTION_CHANGED"}
