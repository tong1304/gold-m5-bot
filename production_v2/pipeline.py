...
from .e1_professional_layer_v7 import analyze_e1_professional_v7
...
class ProductionPipeline:
    ...
    def run(self, market_data: dict[str, Any], *, wait_bars=0, resume_state=None, historical_calibration=None):
        ...
        # E1 V7 is the sole market-state brain. It separates dominant market
        # state from current phase, pressure and volatility, and never creates
        # setup, entry, risk or trade decisions.
        e1 = _dict_result("E1", analyze_e1_professional_v7(bars))
        results["E1"] = e1
