...
_DIRECTION_WORDS = {
    ...
    "BULLISH_BOS": "STRUCTURE_BREAK_UPWARD",
    "BEARISH_BOS": "STRUCTURE_BREAK_DOWNWARD",
    "BULLISH": "UPWARD_STRUCTURE",
    "BEARISH": "DOWNWARD_STRUCTURE",
    "TREND_UP": "UPWARD_TREND_STATE",
    "TREND_DOWN": "DOWNWARD_TREND_STATE",
    "DIRECTION=UP": "PRESSURE=UPWARD",
    "DIRECTION=DOWN": "PRESSURE=DOWNWARD",
    "DIRECTION": "PRESSURE",
}
...
def _sanitize_specialist_result(result: EngineResult) -> EngineResult:
    ...
    return EngineResult(result.engine_id, result.name, None, 0.0, output, result.reason_codes)
