...
def analyze_e8(snapshot:dict[str,Any],upstream:dict[str,EngineResult])->EngineResult:
    ...
    if len(bars)<MIN_BARS:
        return EngineResult("E8",NAME,None,0,{**base,"state":"WAIT","economic_state":"UNRESOLVED","risk_gate":"RISK_NOT_READY","trade_plan":{},"supporting_evidence":[],"counter_evidence":["INSUFFICIENT_CLOSED_CANDLE_DATA"],"missing_evidence":["sufficient risk sample"],"invalidation":["new closed candle"]},("INSUFFICIENT_DATA",))
