...
def analyze_e1(bars):
    ...
    # Market-state classification may be RANGE/COMPRESSION while directional pressure remains meaningful.
    # Do not erase a proven slow directional drift merely because efficiency is low. Balanced rotation
    # remains neutral; persistent directional structure/pressure remains visible to downstream brains.
