...
def analyze_e1(bars: list[dict[str, Any]] | None) -> dict[str, Any]:
    ...
    # TRANSITION requires a genuine regime break. Indicator disagreement alone is only CONFLICT.
    ...
    corroboration = sum((persistent_horizon_flip, ema_context_flip, structure_break_proxy)) >= 1
    ...
    else: state, reason = "UNCLEAR", "evidence is directional but insufficiently coherent for a stronger regime label"
