...
E3 is a single structural-reasoning brain. It reads price structure only,
keeps internal/external structure separate, records conflicts explicitly,
and never authorizes, blocks, gates, scores, or decides a trade.
