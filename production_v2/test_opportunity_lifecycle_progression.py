...
def test_lifecycle_telemetry_is_machine_readable_and_keeps_wait_and_terminal_fields():
    line = lifecycle_telemetry("BTC", {"opportunity_id": "BUY|TREND|E4-22", "event_id": "E4-22", "lifecycle_stage": "E7_CONFIRMED", "state": "WAITING", "wait_for_stage": "E8_READY", "terminal_stage": None, "trade_authorized": False})
