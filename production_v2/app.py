...
from .opportunity.memory import load_all as load_opportunity_memory, backend as opportunity_memory_backend, last_error as opportunity_memory_last_error
...
def _memory_records() -> int:
    try:
        return len(load_opportunity_memory())
    except Exception:
        logger.exception("[PRODUCTION V2] opportunity memory read failed")
        return 0
