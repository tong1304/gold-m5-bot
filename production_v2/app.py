...
app=Flask(__name__); pipeline=ProductionPipeline()
...
def start_production_runtime():
    ...
    if os.getenv("PRODUCTION_V2_DISABLE_LIVE","").strip()=="1":
        print("[PRODUCTION V2] Live runtime disabled by test environment",flush=True); _runtime_started=True; return
    ...
    start_live_service(); _runtime_started=True
