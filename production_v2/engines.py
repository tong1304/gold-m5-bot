...
def run_engine(engine_id,snapshot,evidence_bus=None):
    ...
    if engine_id=="E4":
        # E4 V10 expects a snapshot mapping with bars and only qualitative peer evidence.
