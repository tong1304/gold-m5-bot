...
ENGINE_NAMES = {
    ...
    "E2": "Opportunity / Regime Brain",
    "E3": "Market Structure Brain",
    "E4": "Liquidity Brain",
    "E5": "Location / Value Brain",
    "E6": "Setup Brain",
    "E7": "Confirmation Brain",
    "E8": "Trade Economics Brain",
...
# Hard switch requested by the current architecture decision.
...
def _paused_engine(engine_id: str) -> EngineResult:
    output = {
        "architecture": "ENGINE_INDEPENDENT_SUB_ENGINES_PAUSED",
        "engine_id": engine_id,
        "analysis_status": "PAUSED_SUB_ENGINES",
        "sub_engines_enabled": False,
        "sub_engines": list(SUB_ENGINE_CODES[engine_id]),
        "specialists": {},
        ...
        "reasoning_role": "ENGINE_INDEPENDENT_ANALYST_PAUSED",
        "professional_reasoning": {
            "status": "SUB_ENGINES_PAUSED",
            "question": {
                "E2": "What opportunity is being offered?",
                "E3": "What is price structure communicating?",
                "E4": "Where is liquidity and what did price do with it?",
                "E5": "Is current location advantageous?",
                "E6": "What setup is forming?",
                "E7": "Has the thesis been confirmed?",
                "E8": "Is the trade economically attractive?",
...
def run_engine(engine_id: str, snapshot: dict[str, Any], evidence_bus: dict[str, Any] | None = None) -> EngineResult:
    ...
    if engine_id == "E1":
        ...
        output = {
            "architecture": "E1_INDEPENDENT_PROFESSIONAL_BRAIN_V3",
            "sub_engines_enabled": False,
            "specialists": {},
            "peer_evidence_count": 0,
            "peer_evidence_used": False,
    ...
    if not SUB_ENGINES_ENABLED:
        return _paused_engine(engine_id)

    # Deliberately unreachable until the sub-engine isolation phase is ended.
    return _paused_engine(engine_id)
