...
def _bangkok_display_time(value):
    """Return a stable Thai-local display timestamp for the Statistics UI."""
    if not value:return "—"
    try:
