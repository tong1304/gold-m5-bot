...
def register(app):
    if not _has_route(app,"/statistics"):
        _statistics.register(app); logger.info("V11 statistics route registered: /statistics")
    ...
    if not _has_route(app,"/routes"):
        ...
        def route_status():
            ...
            return Response(json.dumps({"status":"ok","engine_version":"11.0-M5-M15-STRATEGY-SPLIT","statistics":"/statistics" in routes,"replay":"/replay" in routes,"routes":routes},ensure_ascii=False),mimetype="application/json")
