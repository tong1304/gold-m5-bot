...
def test_transition_with_neutral_h1_evaluates_both_m5_trigger_directions():
    context = {"regime": "TRANSITION", "direction": "NEUTRAL", "h1_bias": "NEUTRAL"}
    assert _candidate_directions(context) == ["BUY", "SELL"]


def test_transition_with_h1_bias_evaluates_only_aligned_direction():
    context = {"regime": "TRANSITION", "direction": "BUY", "h1_bias": "BUY"}
