...
def test_gold_0850_pending_high_failed_break_reclaim_survives_as_sell_watch():
    upstream = {
        ...
        "E4": _r("E4", {
            ...
            "finding": "HIGH_FAILED_BREAK_RECLAIM",
            "event_id": "2026-09-03T08:50:00Z|HIGH_FAILED_BREAK_RECLAIM|HIGH|4435.59|DOWN",
        ...
        "E5": _r("E5", {
            ...
            "available_space_atr_long": 0.6238425926,
            "available_space_atr_short": 0.7111625514,
        }),
    }
