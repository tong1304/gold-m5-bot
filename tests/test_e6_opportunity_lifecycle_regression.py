...
def test_pending_low_acceptance_event_survives_e6_as_watch():
    upstream = {
        ...
        "E4": _engine("E4", {
            ...
            "event_id": "2026-09-06T12:05:00Z|LOW_ACCEPTANCE_CANDIDATE|LOW|79922.14|DOWN",
            "auction_state": "PENDING",
            "liquidity_taker": "SELLERS",
            "response_actor": "SELLERS",
            "liquidity_quality": 81.25,
        }),
        "E5": _engine("E5", {
            "finding": "FAVORABLE_LOCATION",
            "value_state": "DISCOUNT",
            "structural_location": "INSIDE_STRUCTURE",
            "available_space_atr_long": 1.217,
            "available_space_atr_short": 0.422,
        }),
    }
