...
def test_watch_survives_one_new_closed_candle_when_identity_and_evidence_persist():
    previous = {
        ...
        "opportunity_id": "BUY|LIQUIDITY_RESPONSE|event-100",
        "direction": "BUY",
...
def test_direction_change_replaces_old_opportunity_instead_of_mutating_it():
    ...
    current = {
        "opportunity_id": "SELL|LIQUIDITY_RESPONSE|event-103",
        "direction": "SELL",
        "setup_family": "LIQUIDITY_RESPONSE",
        "event_id": "event-103",
        "causal_opportunity": True,
...
def test_invalidated_watch_does_not_carry_forward_even_if_same_identity_returns():
    ...
    assert result["opportunity_id"] == "BUY|LIQUIDITY_RESPONSE|event-100"
