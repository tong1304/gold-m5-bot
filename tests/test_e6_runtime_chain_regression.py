...
def _pending_counterflow_fixture():
    return {
        ...
        "E2": _engine("E2", {"finding": "NEUTRAL opportunity is emerging based on closed-candle evidence.", "direction": "NEUTRAL", "opportunity_state": "EMERGING"}),
        "E3": _engine("E3", {"external_state": "MIXED", "internal_state": "DOWN"}),
        "E4": _engine("E4", {"event": "LOW_FAILED_BREAK_RECLAIM", "finding": "LOW_FAILED_BREAK_RECLAIM", "auction_state": "PENDING", "response_actor": "BUYERS", "liquidity_taker": "SELLERS", "event_id": "2026-09-03T10:50:00Z|LOW_FAILED_BREAK_RECLAIM|LOW|4425.23000000|UP"}),
        "E5": _engine("E5", {"finding": "FAVORABLE_LOCATION", "value_state": "EQUILIBRIUM", "structural_location": "INSIDE_STRUCTURE", "available_space_atr_long": 0.2176, "available_space_atr_short": 0.6442}),
    }


def test_runtime_e6_chain_preserves_pending_opportunity_watch():
    result = pipeline_module.analyze_e6({"bars": [], "symbol": "XAU/USD", "timeframe": "M5"}, _pending_counterflow_fixture())
