...
def _finalize(payload):
    """Guarantee one canonical non-empty reason for every engine result."""
...
def analyze(m5,m15=None,symbol=None,index=None,setup_state=None,h1=None):
    ...
    if not score.get("qualified"):
        return _finalize({**base,"valid":False,"signal":"NO_TRADE","entry_type":None,"rejection_reasons":["SETUP_SCORE_BELOW_THRESHOLD"],"trade_levels":{"valid":False}})
