...
ENGINE_VERSION="12.7-MTF-H1-M15-TREND-M5-G1-G3-B1-B3-DYNAMIC-TP"
FORWARD_BARS=12
...
def _asof_context(frame,target_time,timeframe_minutes,max_bars=100):
    ...
    target=target.tz_localize("UTC") if target.tzinfo is None else target.tz_convert("UTC");cutoff=target-pd.Timedelta(minutes=timeframe_minutes)
...
def analyze(m5,m15=None,symbol=None,index=None,setup_state=None,h1=None):
    ...
    if is_gold:return analyze_gold(m5,m15,symbol,index,setup_state,h1)
